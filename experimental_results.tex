...
Figure \ref{fig:E1_boot_mass_loss} displays the test loss at different levels of label noise. The baseline test loss seems to increase slightly as the noise level is increased. The bootstrapping loss function has a lower test loss compared to the baseline for \todo{sjekk} noise levels above 10 percent.\\

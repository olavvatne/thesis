...
\caption{Distribution for non-road patches.} \label{fig:E2_difficulty_distribution_non-road}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
...
Experiment E7, use a teacher that has been trained on fewer examples. Figure 

\begin{figure}[p]
\begin{subfigure}{0.48\textwidth}
\includegraphics[width=\linewidth]{figs/E7/E7_lc_two_stage.png}
\caption{Test loss for two stage dataset} \label{fig:fig:E7_curriculum_inexperienced_loss}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.48\textwidth}
\includegraphics[width=\linewidth]{figs/E7/E7_pr_two_stage.png}
\caption{Precision and recall comparisons for two stage dataset.} \label{fig:fig:E7_curriculum_inexperienced_pr}
\end{subfigure}

\begin{subfigure}{0.48\textwidth}
\includegraphics[width=\linewidth]{figs/E7/E7_lc_gradual.png}
\caption{Test loss for dataset with gradual stage switching} \label{fig:fig:E7_gradual_loss}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\begin{subfigure}{0.48\textwidth}
\includegraphics[width=\linewidth]{figs/E7/E7_pr_gradual.png}
\caption{Precision and recall for dataset with gradual stage switching.} \label{fig:fig:E7_gradual_pr}
\end{subfigure}
\hspace*{\fill} % separation between the subfigures

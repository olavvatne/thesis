...
\end{subfigure}
\hspace*{\fill} % separation between the subfigures
\caption[E3 - Robustness of bootstrapping for increasing amount of label noise]{E3 - Robustness of bootstrapping for increasing amount of label noise. Norwegian Roads Dataset} \label{fig:E5_boot_norway}
\end{figure}

...
\todo[inline]{Draft. Rewrite better.}
...
The dropout method forces the units to rely less on each other, by randomly disabling half of the units in the network during training. This encourage units to encode independently useful information, since dropout penalize co-adaptation between units \citep{Srivastava_dropout}. \\

\todo[inline]{Dropout}
\todo[inline]{What it is. Why it is useful. Why dropout in convolutional layers.}

...
The default loss function for the system, is cross-entropy loss, which in the context of the patch-based approach is denoted \todo{This paragraph is bad}:\\

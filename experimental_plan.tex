...
In addition to presenting the experimental results as \ac{MSE} test loss per epoch plots, the network performance is also presented as precision and recall curves. This is a common metric \todo{used to evaluate??} evaluating road detection systems, as discussed in Section \ref{sec:background_theory}.\\

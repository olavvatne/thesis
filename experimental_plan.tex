...
In Experiment E7, the curriculum strategy was tested with a less experienced curriculum teacher, than in Experiment E1 and E2. This will test whether the proposed curriculum strategy is viable with a teacher that has trained with a limited number of examples. This curriculum teacher will probably lead to different difficulty estimates, than an experienced teacher. The experiment also tested the effect of just training on the first stage examples, and test a gradual approach of changing the training set distribution. This involves having several smaller stages mixed into the training set by random replacement.\\

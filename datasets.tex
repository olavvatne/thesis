...
Furthermore, the aerial images might present a challenge in terms of image quality. Some of the images have a lower quality, and differs in color balance, and contrast. There are also images which have been stitched together by from  images captured by different flyovers \todo{CHECK what the heck this should be. OUTRAGEOUS}.\\  
...
\todo[inline]{rewrite last sentence}
\begin{table}[htp]

...
The curriculum teacher for \todo{for ok} this experiment was trained with a patch dataset of 442800 examples, sampled from Massachusetts Roads Dataset. The teacher classifier was trained for 272 epochs. It achieved a \ac{MSE} test loss of 0.0225, and a relaxed precision and recall breakeven point of 0.80.\\
...
experiment assumed that there are \todo{is?} a limited amount of patches available. The teacher for \todo{for?} this experiment was therefore only trained with 221600 examples, which is the same number of examples in each patch dataset. The model was trained for 156 epochs, and achieved a \ac{MSE} test loss of 0.0253 and a relaxed precision and recall breakeven point of 0.79.\\

...
The default network configuration was used for \todo{ for, spurt Ollie} the networks trained on the patch datasets. Essentially, the only real difference between them was the first stage of the datasets. The networks were trained for 120 epochs with a stage switch at epoch 50. Important parameters of this experiment are listed in Table \ref{tab:key_parameter_E5}.\\

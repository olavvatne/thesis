...
For installation instructions, see Appendix \ref{app:monitorInstall} and Appendix \ref{app:ubuntuInstall}. Alternatively, installation guides are included in the README files of the repositories. The URL of these repositories are listed below:
...
\noindent Include the paths to cuda nvcc and ld\_library\_path in the .bashrc file, and then reboot \todo{Actually how the bashrc file looks like}:

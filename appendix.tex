...
\item Appendix figures update
\item Figure update. MSE test loss in yaxis. Same for every figure. Remove validation loss. Do not use it anywhere
\item Remove MSE except from 4.1. Averaged should also be removed
\item Paragraph 4, somewhere is unprecise.
\item Do I explain the better results for first stage in discussion? If not some material is commented out in results.
\item Introduce confident earlier in results. Introductory section
\item Gradual curriculum pr points do not match
\item Forklar bedre hva dataset resultater kommer ifra.
\item Integrer caption i raatekst avsnitt.
\item Resultat - budskap om at forskjellene er ganske smaa maa bedre frem.
\item E4 and E5 in results need to be swapped.
\item E4 and E5 is mixed up in the text.
\item Paragraphs in results detailing the result tables better.
...
\item Contradictory mse and pr, repeated in experiment results and discussion.
...
\item Thoroughly fact check the Welch paragraphs
\item Appendix for other results? Random noise results? 
\item Consider all todos
\item proof read

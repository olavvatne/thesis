...
\item british english - ize allowed. If not Choose either one?
\item Appendix Random noise results. Random noise and omission noise comparison, test loss summary. Small text? 
\item Sammendrag på norsk
\end{itemize}

...
\caption[Patch examples]{Aerial image and label examples from a patch dataset. The patches originate from the Norwegian Roads Dataset. Each label indicates the road ground truth from the center location of the aerial patch.  }
